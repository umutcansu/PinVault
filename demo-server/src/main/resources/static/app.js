...
const i18n = {
  tr: {
    ...
    encDescE2E: 'Yalnızca hedef cihaz açabilir — sunucu bile içeriği göremez. Cihazın açık anahtarı gerekir; bunu uygulama (PinVault) otomatik üretip kaydeder, sen elle bir şey girmezsin. Cihaz uygulamada E2E olarak ayarlı değilse anahtar kaydı olmaz ve indirme "412 (anahtar yok)" döner.',
  ...
  en: {
    ...
    encDescE2E: 'Only the target device can open it — not even the server can read the content. It needs the device public key; the app (PinVault) generates and registers it automatically — you don\'t paste anything. If the device app isn\'t set up for E2E there is no key, and the download returns "412 (no key)".',
